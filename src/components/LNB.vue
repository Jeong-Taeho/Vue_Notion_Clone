<template>
  <nav ref="nav" :style="{ width: `${navWidth}px` }">
    ...
    <ul>
      <workspace-item v-for="workspace in workspaces" :key="workspace.id" :workspace="workspace" />
    </ul>
    <div class="actions">
...
nav {
  ...
  .header {
    ...
    .user-profile {
      ...
      border-radius: 4px;
      margin-right: 10px;
      background-image: url("https://avatars.githubusercontent.com/u/117630589?v=4");
